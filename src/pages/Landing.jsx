      ...
      >
        ...
        >
          <g>
            <path
              fill="var(--primary)"
              d="M11.48,10.1L3.44,15.32c.23.74.55,1.47.99,2.18.4.64,1.24,1.34,2.34,1.97l4.71-9.37Z"
            />
            <path
              fill="var(--primary)"
              d="M11.97,10.4l-.37,10.95c1.43.33,2.92.49,4.32.39l-3.95-11.35Z"
            />
            <path
              fill="var(--primary)"
              d="M11.7,10.29l-4.68,9.33c1.22.67,2.73,1.27,4.32,1.67l.37-11Z"
            />
            <path
              fill="var(--primary)"
              d="M3.76,8.55c-.7,1.67-1.06,4.06-.42,6.45l8.06-5.24-7.64-1.21Z"
            />
            <path
              fill="var(--primary)"
              d="M11.33,9.4l-4.76-4.23c-1.13.82-2.17,2.05-2.67,3.06l7.43,1.17Z"
            />
            <path
              fill="var(--primary)"
              d="M11.85,9.45l5.12-4.9c-2.35-.88-5.28-1.14-5.41-.3-.12.79-.06,3.14.22,4.45.02.12-.1.19-.15.08-.3-.69-.44-1.88-1.27-3.43-.78-1.46-2.19-1.23-3.53-.36l5.01,4.46Z"
            />
            <path
              fill="var(--primary)"
              d="M12.23,10.31l3.97,11.41c1.72-.17,3.28-.76,4.41-1.93l-8.39-9.48Z"
            />
            <path
              fill="var(--primary)"
              d="M12.29,9.46l9.62-.58c-.82-1.5-1.98-2.53-2.86-3.23-.46-.37-1.08-.69-1.76-.97l-5.01,4.79Z"
            />
            <path
              fill="var(--primary)"
              d="M20.82,19.57c.39-.46.73-.99.99-1.62.52-1.24.83-2.38.99-3.41l-10.36-4.44,8.38,9.47Z"
            />
            <path
              fill="var(--primary)"
              d="M22.85,14.19c.25-2.04-.13-3.68-.77-4.98l-9.5.58,10.27,4.41Z"
            />
          </g>
        </svg>
      </div>
